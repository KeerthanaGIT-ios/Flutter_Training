class TimesheetWithdrawResponse {
  final bool success;
  ...
  factory TimesheetWithdrawResponse.fromJson(Map<String, dynamic> json) {
    return TimesheetWithdrawResponse(
...
class WithdrawData {
  final List<WithdrawWeekData> data;
  ...
  factory WithdrawData.fromJson(Map<String, dynamic> json) {
    return WithdrawData(
      data: (json['data'] as List).map((e) => WithdrawWeekData.fromJson(e)).toList(),
...
class WithdrawWeekData {
  ...
  factory WithdrawWeekData.fromJson(Map<String, dynamic> json) {
    return WithdrawWeekData(
      week: json['week'] ?? '',
      weekId: json['week_id'] ?? '',
      shifts: (json['shifts'] as List).map((e) => WithdrawShift.fromJson(e)).toList(),
    );
  }
}
...
class WithdrawShift {
  ...
  factory WithdrawShift.fromJson(Map<String, dynamic> json) {
...
// Reuse these if shared with Submitted model
class Client {
  final String id;
  final String name;
